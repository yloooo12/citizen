...
if (isset($_POST['mark_all_read'])) {
    ...
    $stmt->execute();
    $stmt->close();
    header("Location: secretary_notifications.php");
    exit;
}
...
<head>
    ...
    <title>Notifications - Secretary</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .notification-icon { width: 45px; height: 45px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.2rem; flex-shrink: 0; }
        ...
        @media (max-width: 768px) {
            ...
            .notifications-header { flex-direction: column; gap: 1rem; align-items: flex-start; }
        }
    </style>
</head>
<body>
