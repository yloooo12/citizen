    ...
    <div class="nav-container">
        <div class="logo-section">
            ...
            <div class="logo-text">
                ...
                <p>Crediting Management System</p>
            </div>
        </div>
...
<aside class="sidebar" id="sidebar">
    <nav class="sidebar-menu">
        <a href="program_head_dashboard.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'program_head_dashboard.php' ? 'active' : ''; ?>">
            <i class="fas fa-th-large"></i>
            <span>Dashboard</span>
        </a>
        <a href="program_head_requests.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'program_head_requests.php' ? 'active' : ''; ?>">
            <i class="fas fa-clipboard-check"></i>
            <span>Crediting Requests</span>
        </a>
        <a href="program_head_students.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'program_head_students.php' ? 'active' : ''; ?>">
            <i class="fas fa-users"></i>
            <span>Student Directory</span>
        </a>
        <a href="program_head_activity.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'program_head_activity.php' ? 'active' : ''; ?>">
...
<div class="notification-dropdown" id="notificationDropdown">
    <div class="notif-header">
        ...
        <a href="program_head_notifications.php" class="notif-view-all">View All</a>
    </div>
